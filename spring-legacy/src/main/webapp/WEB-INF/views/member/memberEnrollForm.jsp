...
<body>
	...
	<div class="outer">
		...
		<%-- 
			<form:form>
				- form 태그에 데이터를 자동으로 바인딩
				- 코드의 가독성과 유지보수성 향상을 위해 사용
				- form 태그에 바인딩할 객체는 서버에서 model 추가해서 삽입
		...
		<form:form modelAttribute="member" id="enroll-form" action="${contextPath}/security/insert" method="post">
			<!-- 회원가입form안에.txt -->
			<table align="center">
				<tr>
					<td>* ID</td>
